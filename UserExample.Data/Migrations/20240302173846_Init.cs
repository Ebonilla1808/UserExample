        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name_SecondName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ContactInformation_AlterPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_Country = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_AditionalInformation = table.Column<string>(type: "nvarchar(max)", nullable: false),
